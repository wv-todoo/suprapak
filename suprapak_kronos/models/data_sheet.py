...
class DataSheet(models.Model):
    ...
    def action_create_quotation(self):
        ...
        for record in self:
            ...
            vals = {
                ...
                'specification_width': record.specification_width,
                'specification_long': record.specification_long,
    ...
    def action_new_quotation(self):
        ...
        vals = {
            ...
            'specification_width': self.specification_width,
            'specification_long': self.specification_long,
